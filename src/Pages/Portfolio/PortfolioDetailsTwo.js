            ...
            <div className="col-xl-4 col-lg-4 lg-mb-30">
              <div className="portfolio__details-two-left">
                <div className="portfolio__details-two-left-content">
                  ...
                  <p className="mb-20">
                    Maecenas tincidunt hendrerit odio sed consectetur. Duis
                    porta purus sapien, eget pretium augue consectetur ut. Nunc
                    nibh augue, pretium quis imperdiet pellentesque, molestie
                    eget nisi. Sed rutrum sit amet eros ac egestas.
                  </p>
                  <p>
                    Maecenas tincidunt dolor in massa iaculis, vitae dignissim
                    sem finibus. Pellentesque elementum vel arcu sit amet
                    rhoncus. Nulla at eleifend lorem. Praesent et ex sed metus
                  </p>
                </div>
